...
function CardConsumptionDB({ data, title }) {
        ...
        for (const item of data) {
            if (item.timestamp - groupStart < intervalMinutes * 60 * 1000) {
                ...
                result.push({
                    ...
                    non_shiftable_load: tempGroup.reduce((sum, i) => sum + i.non_shiftable_load, 0)
                });
        ...
        <>
            ...
            <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={aggregatedData} stackOffset="sign">
                    ...
                    />
                    <Legend />
                    <Bar dataKey="non_shiftable_load" stackId="a" fill="#8884d8" />
                </ComposedChart>
            </ResponsiveContainer>
...
export default CardConsumptionDB;
